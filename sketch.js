...
//function resetting for the game
function reset() {
 
  //changing game to play state, changing the visibility, animation of the girl, destroying the obstacle and diamonds
  //making score and diamond collected as 0 
  gameState = PLAY;
  gameOver.visible = false;
  restart.visible = false;
...
function spawnObstacles(){
  //to display obstacles after intervals 
  if (frameCount % 100 === 0) {
    ...
    //to add obstacle to group
    obstaclesGroup.add(obstacle);
  
    //to see the collision radius
    obstacle.debug = false;
    // to set collision radii
    obstacle.setCollider("circle", 0, 0, 1);

    //set lifetime of obstacle
